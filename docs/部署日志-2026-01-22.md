...
- ✅ 修改 QQ 邮箱授权码（已完成）
  - 旧授权码：`lybcqqdecxcobjii`（已删除）
  - 新授权码：`vcmhzyagfkmbbjcb`
- ✅ 修改数据库密码为强密码
...
- **前端访问**：http://47.95.43.38
- **后端 API**：http://47.95.43.38/api
...
**部署开始时间**：2026年1月22日 约 15:30
**部署完成时间**：2026年1月22日 约 19:30（预计）
...
| 首次构建 | 10分钟 | 60分钟+ | npm 源问题卡住 28 分钟 |
| 调试问题 | 10分钟 | 60分钟+ | 密码、volume、Dockerfile 等问题 |
| **总计** | **50分钟** | **约4小时** | 遇到多个镜像源和配置问题 |
